    ...
    <SubContainer className="flex flex-col items-center justify-center bg-dark text-light">
      ...
      <div className="flex flex-col justify-between gap-5 absolute top-20">
        ...
        <div className="flex flex-row justify-center items-center gap-5">
          <Button
            label="Cancelar"
            className="w-1/2 rounded-e rounded-l border-2 border-purple/75 bg-transparent text-light p-2 mb-8 px-6 py-3 hover:bg-purple border-purple transition ease-in duration-300"
            onClick={handleCancel}
          />
          <Button
            label="Salvar"
            className="w-1/2 rounded-e rounded-l border-none bg-purple/75 text-light p-2 mb-8 px-6 py-3 hover:bg-purple transition ease-in duration-300"
            onClick={handleSave}
          />
          {!id ? (
            <Button
              label="Sign out"
              className="w-1/2 rounded-e rounded-l border-none bg-yellowDark/75 p-2 mb-8 px-6 py-3 hover:bg-yellowDark transition ease-in duration-300"
